  ...
  static route(data, overrideDomain = null) {
    ...
    const result = (() => {
      switch (context.domain) {
        ...
        case "finance":          return FinanceAnalyzer.analyzeDomain(data, context);
        case "inventory":        return InventoryAnalyzer.analyzeDomain(data, context);
        case "hr":               return HRPayrollAnalyzer.analyzeDomain(data, context);
        case "health":           return HealthAnalyzer.analyzeDomain(data, context);
        case "academic":         return AcademicAnalyzer.analyzeDomain(data, context);
        case "business_sales":   return FinanceAnalyzer.analyzeDomain(data, context);
        default:                 return GenericAnalyzer.analyzeDomain(data, context);
      }
    })();
