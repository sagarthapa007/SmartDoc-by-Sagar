...
export default function AdminRoles() {
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-500 mb-6">Only Admins should see & edit this in future.</p>
          ...
          <tbody>
            {demoUsers.map(u => (
              <tr key={u.id} className="border-t">
                ...
                <td className="p-3">
                  <button className="px-3 py-1.5 rounded-lg border">Change Role</button>
                </td>
              </tr>
            ))}
          </tbody>
      ...
      <div className="mt-6 text-xs text-gray-500">Signed in as: {user?.email} ({user?.role})</div>
    </div>
  );
}
